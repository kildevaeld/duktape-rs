...
use super::super::privates::{get_data, init_data};
use super::super::property::{Property, PropertyBuilder};
...
pub trait ContextObject {
    fn global<'a>(&'a self) -> Object<'a>;
    fn stash<'a>(&'a self) -> Object<'a>;
}
